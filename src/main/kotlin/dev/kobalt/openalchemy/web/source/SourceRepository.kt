...
package dev.kobalt.openalchemy.web.source
...
object SourceRepository {
    ...
    fun selectList(): List<Triple<String, String, String>> = listOf(
        Triple("dev.kobalt.openalchemy.jvm", "Application", "Executable JAR of this application."),
        Triple(
            "dev.kobalt.openalchemy.web",
            "Frontend",
            "Website server that provides this page."
        )
    )
